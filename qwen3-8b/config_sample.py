...
# Model configuration
VER = 2
MODEL_NAME = "/kaggle/input/qwen-3-8b"
...
# Training parameters
TRAIN_BATCH_SIZE = 2  # Batch size 2 for RTX 5090 with 31GB VRAM
EVAL_BATCH_SIZE = 4  # Eval can use larger batch size
GRADIENT_ACCUMULATION_STEPS = 32  # Reduced to 32 for faster training
LEARNING_RATE = 2e-4
LOGGING_STEPS = 50
SAVE_STEPS = 200
EVAL_STEPS = 200
...
WANDB_PROJECT = "qwen3-8b-math-misconceptions"
WANDB_RUN_NAME = f"qwen3-8b-ver{VER}"
