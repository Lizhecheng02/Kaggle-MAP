...
import pandas as pd
from transformers import DebertaV2ForSequenceClassification, DebertaV2Tokenizer, Trainer
...
def main():
    ...
    # モデルとトークナイザーの読み込み
    model = DebertaV2ForSequenceClassification.from_pretrained(BEST_MODEL_PATH)
    tokenizer = DebertaV2Tokenizer.from_pretrained(BEST_MODEL_PATH)
