...
def format_input(row):
    ...
    # misconceptionsを改行で結合した文字列を変数に格納
    miscs_text = "\n".join(misconceptions)
    ...
    prompt = (
        ...
        f"Possible Misconceptions:\n{miscs_text}"
        f"Task: Identify the mathematical misconception in this student's reasoning. Choose NA if 'not applicable'.\n\n"
        "<|im_end|>\n<|im_start|>assistant\n<think>\n\n</think>\n\n"
    )
    return prompt
