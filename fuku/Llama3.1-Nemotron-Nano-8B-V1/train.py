"""
Llama-3.1-Nemotron-Nano-8B-v1 モデルトレーニングスクリプト
"""
...
# カスタムモジュールのインポート
from config import *
from utils import prepare_correct_answers, format_input, tokenize_dataset, compute_map3, load_llama_tokenizer
...
class LlamaForSequenceClassification(nn.Module):
    """Llama-3.1-Nemotron-Nano-8Bモデルを分類タスク用にカスタマイズ"""
...
def main():
    ...
    try:
        ...
        # 失敗した場合はカスタムクラスを使用
        print("Using custom classification head for Llama-3.1-Nemotron-Nano-8B...")
        # ベースモデルを読み込む
        ...
        # カスタム分類ヘッドを作成
        model = LlamaForSequenceClassification(MODEL_NAME, n_classes)
