...
# Model configuration
VER = "awq"
MODEL_NAME = "/hdd/models/Qwen2.5-32B-AWQ"
MODEL_TYPE = "qwen2.5"  # Qwen2.5 model type for AWQ
...
WANDB_PROJECT = "qwen2.5-32b-awq-math-misconceptions"
WANDB_RUN_NAME = f"qwen2.5-32b-awq-ver{VER}"
...
AWQ_FUSE_LAYERS = True  # Enable layer fusion for Qwen2.5
