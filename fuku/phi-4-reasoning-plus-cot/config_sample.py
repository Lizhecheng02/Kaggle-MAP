...
MAX_LEN = 500  # Phi-4-reasoning-plus supports 32k context, but we use 1024 for efficiency
...
COT_DATA_PATH = 'train_cot_gemini_2_5_flash.parquet'  # Chain of Thought data for distillation
...
LORA_RANK = 70  # LoRAのランク - optimized for Phi-4
LORA_ALPHA = 140  # LoRAのスケーリングパラメータ - 1:1 ratio with rank
