...
# Model configuration
VER = 1
MODEL_NAME = "/kaggle/input/ettin-encoder-1b"
EPOCHS = 3
MAX_LEN = 256
...
TRAIN_BATCH_SIZE = 16
EVAL_BATCH_SIZE = 32
GRADIENT_ACCUMULATION_STEPS = 4  # Increase this when reducing batch size to simulate larger batches
LEARNING_RATE = 5e-5
LOGGING_STEPS = 50
SAVE_STEPS = 200
EVAL_STEPS = 200
...
SYNTHETIC_DATA_PATH = '/kaggle/input/map-charting-student-math-misunderstandings/synthe_train.csv'
TEST_DATA_PATH = '/kaggle/input/map-charting-student-math-misunderstandings/test.csv'

# Synthetic data settings
USE_SYNTHETIC_DATA = True  # 合成データを使用するかどうか
...
# WANDB settings
WANDB_PROJECT = 'ettin-encoder-1b-math-misconceptions'
