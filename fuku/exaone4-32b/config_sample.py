"""
設定ファイル - EXAONE-4.0-32B モデルのトレーニングと推論用設定
"""

# Model configuration
VER = "4bit"
MODEL_NAME = "/hdd/models/EXAONE-4.0-32B"
MODEL_TYPE = "exaone"  # EXAONE model type
...
WANDB_PROJECT = "exaone4-32b-math-misconceptions"
WANDB_RUN_NAME = f"exaone4-32b-ver{VER}"
