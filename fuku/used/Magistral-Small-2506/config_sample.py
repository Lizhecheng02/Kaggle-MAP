"""
設定ファイル - Magistral-Small-2506 モデルのトレーニングと推論用設定
"""

# Model configuration
VER = 2
MODEL_NAME = "/kaggle/input/Magistral-Small-2506"
MODEL_TYPE = "llama"  # Magistral-Small-2506 model type
EPOCHS = 3  # Reduce epochs for initial testing
MAX_LEN = 250  # Magistral-Small-2506 context length

# Directory settings
OUTPUT_DIR = f"ver_{VER}"

# Training parameters
TRAIN_BATCH_SIZE = 4  # Batch size for Magistral-Small-2506
...
WANDB_PROJECT = "magistral-small-math-misconceptions"
WANDB_RUN_NAME = f"magistral-small-ver{VER}"
...
# LoRA configuration for Magistral-Small-2506
LORA_RANK = 32  # LoRAのランク - optimized for Magistral-Small-2506
LORA_ALPHA = 64  # LoRAのスケーリングパラメータ - 2:1 ratio with rank
LORA_TARGET_MODULES = ["q_proj", "v_proj", "k_proj", "o_proj", "gate_proj", "up_proj", "down_proj"]  # Magistral-Small-2506 target modules
LORA_DROPOUT = 0.1  # LoRAのドロップアウト率 - reduced for Magistral-Small-2506
