...
# カスタムモジュールのインポート
from config import *
from utils import prepare_correct_answers, format_input, tokenize_dataset, compute_map3, update_question_texts
...
def main():
    ...
    train = update_question_texts(train, context="train")
