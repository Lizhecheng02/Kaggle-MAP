...
# Model configuration
VER = 2
MODEL_NAME = "/hdd/models/qwen-3-8b"
...
# Training parameters
TRAIN_BATCH_SIZE = 32  # Batch size 2 for RTX 5090 with 31GB VRAM
EVAL_BATCH_SIZE = 32  # Eval can use larger batch size
...
WANDB_PROJECT = "qwen3-4b-math-misconceptions"
WANDB_RUN_NAME = f"qwen3-4b-ver{VER}"
...
# LoRA configuration
LORA_RANK = 512  # LoRAのランク - reduced for memory efficiency
LORA_ALPHA = 512  # LoRAのスケーリングパラメータ - reduced proportionally
