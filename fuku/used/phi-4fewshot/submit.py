...
def main():
    ...
    print("Loading training data for correct answers and few-shot pool...")
    # 正解答案データの準備（訓練データから取得）+ few-shotプール作成
