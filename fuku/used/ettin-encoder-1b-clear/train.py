...
# カスタムモジュールのインポート
from config import *
from utils import prepare_correct_answers, format_input, tokenize_dataset, compute_map3, preprocess_data
...
def main():
    ...
    train_for_format = train.copy()
    train_for_format['StudentExplanation'] = train['FixedStudentExplanation']
    train['text'] = train_for_format.apply(format_input, axis=1)
