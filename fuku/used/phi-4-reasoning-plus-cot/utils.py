...
def format_input(row):
    ...
    # CoT（Chain of Thought）がある場合はそれを使用
    if 'think' in row and pd.notna(row['think']):
        cot_reasoning = row['think']
    else:
        # CoTがない場合はデフォルトの推論テキストを使用
        cot_reasoning = "Let me analyze this mathematical misconception..."
