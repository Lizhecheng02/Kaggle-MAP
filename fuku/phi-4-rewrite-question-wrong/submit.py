...
# カスタムモジュールのインポート
from config import *
from utils import prepare_correct_answers, format_input, tokenize_dataset, create_submission, rewrite_questions, wrong_fraction_decoder
...
def main():
    ...
    # QuestionTextの書き換えを適用
    test = rewrite_questions(test, REWRITE_QUESTION_LIST)
