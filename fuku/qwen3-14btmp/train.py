...
def main():
    ...
    # --- QuestionId 32835 の QuestionText を更新（データ修正） ---
    try:
        ...
        if 'QuestionId' in train.columns and 'QuestionText' in train.columns:
            ...
            update_count = int(mask_32835.sum())

            if update_count > 0:
                original_text = str(train.loc[mask_32835, 'QuestionText'].iloc[0])
            ...
            print("Columns 'QuestionId' or 'QuestionText' not found; skipping update.")
    except Exception as e:
        print(f"Warning: failed to update QuestionId 32835: {e}")
