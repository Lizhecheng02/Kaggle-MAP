"""
AceMath-7B-Instruct モデルトレーニングスクリプト
"""
...
class GenericEncoderForSequenceClassification(nn.Module):
    """任意のエンコーダモデルに線形分類ヘッドを付与"""
...
def main():
    ...
    try:
        ...
        # 失敗した場合はカスタムクラスを使用
        print("Using generic backbone + classification head...")
        # ベースモデルを読み込む
        ...
        # カスタム分類ヘッドを作成
        model = GenericEncoderForSequenceClassification(MODEL_NAME, n_classes, ATTENTION_IMPLEMENTATION)
