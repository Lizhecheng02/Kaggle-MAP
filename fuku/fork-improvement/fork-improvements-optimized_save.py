...
if __name__ == '__main__':
    ...
    skf = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)  # 高速化のため3分割
    ...
    xgb_params = {
        ...
        'max_depth': 8,  # 8から10に増加
        'learning_rate': 0.1,  # 0.1から0.05に減少
        'subsample': 0.8,  # 0.8から0.85に増加
        'colsample_bytree': 0.8,  # 0.8から0.85に増加
        'random_state': 42,
