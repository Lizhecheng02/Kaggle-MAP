...
# Model configuration
VER = 2
MODEL_NAME = "/kaggle/input/qwen2.5-VL-3b-instruct"
...
WANDB_PROJECT = "qwen2.5-VL-3b-math-misconceptions"
WANDB_RUN_NAME = f"qwen2.5-VL-3b-ver{VER}"
...
LORA_R = 16  # LoRAのランク（小さいほどパラメータ数が少ない）
LORA_ALPHA = 32  # LoRAのスケーリングパラメータ（通常はrの2倍程度が推奨）
