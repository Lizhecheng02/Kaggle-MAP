...
# Training parameters
TRAIN_BATCH_SIZE = 32  # Smaller batch size for Phi-4
EVAL_BATCH_SIZE = 32  # Eval batch size
GRADIENT_ACCUMULATION_STEPS = 1  # Increased for effective batch size
LEARNING_RATE = 2e-4
LOGGING_STEPS = 10
SAVE_STEPS = 458
EVAL_STEPS = 458
...
LORA_ALPHA = 16  # LoRAのスケーリングパラメータ - 1:1 ratio with rank
