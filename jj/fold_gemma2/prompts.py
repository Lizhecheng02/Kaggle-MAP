...
def create_prompt_think_v1(tokenizer, row):
    ...
    messages = [
        ...
        {
            "role": "assistant",
            "content": f"<think>{row['think']}</think>\n\n",
        },
    ]
...
def create_prompt_think_v2(tokenizer, row):
    if row["is_correct"]:
        status = "Yes"
        correct = "correct"
    else:
    ...
    messages = [
        ...
        {
            "role": "assistant",
            "content": f"<think>Let me think. The student got the question {correct}. The student wrote \"{row['StudentExplanation']}\". Let's analyze whether the student correctly explained the answer, or if the student had a misconception, or if the explanation is neither.</think>\n\n",
        },
    ]
...
def create_prompt_simple_v1(tokenizer, row):
...
def create_prompt_v3(tokenizer, row):
    ...
    messages = [
        ...
        {
            "role": "assistant",
            "content": "<think>Let me analyze this student's explanation to see if they gave a correct explanation, a wrong explanation that shows they have a misconception, or neither.</think>\n\n",
        },
    ]
...
def create_prompt_mistral_v1(tokenizer, row):
    if row["is_correct"]:
        status = "Yes"
    else:
        status = "No"
...
prompt_registry = {
    ...
    "create_prompt_think_v2": create_prompt_think_v2,
    "create_prompt_simple_v1": create_prompt_simple_v1,
    "create_prompt_v3": create_prompt_v3,
    "create_prompt_mistral_v1": create_prompt_mistral_v1,
}
