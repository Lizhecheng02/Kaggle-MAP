...
def main():
    ...
    try:
        ...
        # 失敗した場合はカスタムクラスを使用
        print("Using custom classification head for Qwen2.5...")
        # ベースモデルを読み込む
        from transformers import AutoModel
        ...
        # カスタム分類ヘッドを作成
        model = QwenForSequenceClassification(MODEL_NAME, n_classes, ATTENTION_IMPLEMENTATION)
